...
export default function AIInsights() {
    ...
    const getInsight = async (type) => {
        ...
        const data = {
            ...
            prompt: `You are Simon AI — a business intelligence engine for service providers on ServiceFlow. ${type.prompt(data)}. Be specific, actionable, and data-driven. Format with markdown.`,
