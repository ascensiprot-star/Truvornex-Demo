...
const labelStyle = { fontSize: 15, fontWeight: 700, letterSpacing: '0.08em', textTransform: 'uppercase', display: 'flex', alignItems: 'center', gap: 6, marginBottom: 6, color: 'var(--color-text-subtle)' };
const fieldStyle = { height: 44, padding: '0 12px', display: 'flex', alignItems: 'center', borderRadius: 12, backgroundColor: 'var(--color-surface-high)', border: '1px solid var(--color-border)', fontSize: 18, color: 'var(--color-text-muted)' };
