                    ...
                    <div className="card-premium p-6">
                        ...
                        <ResponsiveContainer width="100%" height={240}>
                            <AreaChart data={monthly}>
                                ...
                                <XAxis dataKey="month" tick={{ fontSize: 16, fill: colors.text }} />
                                <YAxis tick={{ fontSize: 16, fill: colors.text }} />
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                        ...
                        <div className="card-premium p-6">
                            ...
                            <ResponsiveContainer width="100%" height={200}>
                                <BarChart data={byDay}>
                                    <CartesianGrid strokeDasharray="3 3" stroke={colors.grid} />
                                    <XAxis dataKey="day" tick={{ fontSize: 16, fill: colors.text }} />
                                    <YAxis tick={{ fontSize: 16, fill: colors.text }} />
                                    <Tooltip {...tooltipStyle} />
                    ...
                    <div className="card-premium p-6">
                        ...
                        <ResponsiveContainer width="100%" height={280}>
                            <BarChart data={byCategory} layout="vertical">
                                <CartesianGrid strokeDasharray="3 3" stroke={colors.grid} />
                                <XAxis type="number" tick={{ fontSize: 16, fill: colors.text }} />
                                <YAxis dataKey="category" type="category" tick={{ fontSize: 16, fill: colors.text }} width={100} />
                                <Tooltip {...tooltipStyle} formatter={(v) => [`$${v.toLocaleString()}`, 'Revenue']} />
