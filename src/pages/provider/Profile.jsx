...
const labelStyle = { fontSize: 16, fontWeight: 600, color: 'var(--color-text-muted)', display: 'block', marginBottom: 6 };
        ...
        <div className="max-w-2xl pb-8 space-y-4">
            ...
            <div className="rounded-xl p-5 space-y-4" style={{ backgroundColor: 'var(--color-surface)', border: '1px solid var(--color-border)' }}>
                <div className="flex items-center justify-between">
                    ...
                    <button style={{ ...btnBase, backgroundColor: 'var(--color-surface-high)', color: 'var(--color-text-muted)', border: '1px solid var(--color-border-strong)', padding: '5px 10px', fontSize: 16 }}
